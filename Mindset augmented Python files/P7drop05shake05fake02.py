...
FAKE_CLASS = 3
DROPPED_CLASS = -1
DROP_PROB = 0.5       # 50% drop
SHAKE_STD = 0.05      # noise std for shaker
...
for epoch in range(Nepoch):
    ...
    for i in range(nbatches):
        ...
        for j in range(x_batch.shape[0]):
            ...
            xj, yj = inject_fake_frequencies(xj, yj, max_fake_fraction=MAX_FAKE_FRACTION)
...
# Save everything
torch.save(model.state_dict(), "segmentation_pointnet_drop05shake05fake02.pth")
with open("train_history_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_history_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("output_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(test_out, f)
with open("cost_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targets_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(test_targets, f)
with open("test_predictions_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(test_predictions, f)
with open("per_point_losses_test_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(per_point_loss, f)
with open("average_loss_per_model_drop05shake05fake02.pkl", "wb") as f:
    pickle.dump(per_model_loss, f)
with open("test_accuracy_drop05shake05fake02.pkl", "wb") as f:
