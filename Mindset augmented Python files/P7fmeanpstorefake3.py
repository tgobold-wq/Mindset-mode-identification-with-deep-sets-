...
torch.save(model.state_dict(), "segmentation_pointnet_fmeanpstorefake3.pth")

with open("train_history_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(history_train, f)
with open("test_history_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(history_test, f)
with open("train_acc_history_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(history_train_acc, f)
with open("test_acc_history_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(history_test_acc, f)
...
with open("output_logits_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(test_out.cpu().numpy(), f)
with open("output_probs_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(test_probs, f)
with open("cost_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(cost_test, f)
with open("test_targets_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(test_targets, f)
with open("test_predictions_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(test_predictions, f)
with open("per_point_losses_test_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(per_point_loss, f)
with open("average_loss_per_model_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(per_model_loss, f)
with open("test_accuracy_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(test_accuracy, f)
with open("fake_data_test_fmeanpstorefake3.pkl", "wb") as f: pickle.dump(fake_data_test, f)
