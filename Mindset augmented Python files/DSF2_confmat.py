...
torch.save(model.state_dict(), "segmentation_pointnet_DSF2cm.pth")
with open("train_history_DSF2cm.pkl", "wb") as f: pickle.dump(history_train, f)
with open("val_history_DSF2cm.pkl", "wb") as f: pickle.dump(history_val, f)
with open("val_acc_history_DSF2cm.pkl", "wb") as f: pickle.dump(history_val_acc, f)
...
with open("test_predictions_DSF2cm.pkl", "wb") as f: pickle.dump(test_predictions, f)
with open("test_targets_DSF2cm.pkl", "wb") as f: pickle.dump(test_targets, f)
with open("output_probs_DSF2cm.pkl", "wb") as f: pickle.dump(test_probs, f)
with open("per_point_losses_test_DSF2cm.pkl", "wb") as f: pickle.dump(per_point_loss_flat, f)
with open("average_loss_per_model_DSF2cm.pkl", "wb") as f: pickle.dump(avg_loss_per_sample, f)
