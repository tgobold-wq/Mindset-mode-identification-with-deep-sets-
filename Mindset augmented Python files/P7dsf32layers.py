...
# Save everything
torch.save(model.state_dict(), "segmentation_pointnet_dsf32layers.pth")
with open("train_history_dsf32layers.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_history_dsf32layers.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("output_dsf32layers.pkl", "wb") as f:
    pickle.dump(test_out, f)
with open("cost_dsf32layers.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targets_dsf32layers.pkl", "wb") as f:
    pickle.dump(test_targets, f)
with open("test_predictions_dsf32layers.pkl", "wb") as f:
    pickle.dump(test_predictions, f)
with open("per_point_losses_test_dsf32layers.pkl", "wb") as f:
    pickle.dump(per_point_loss, f)
with open("average_loss_per_model_dsf32layers.pkl", "wb") as f:
    pickle.dump(per_model_loss, f)
with open("test_accuracy_dsf32layers.pkl", "wb") as f:
