...
torch.save(model.state_dict(), "segmentation_pointnet_dsfmeanpstorefake.pth")
with open("output_logits_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(test_out.cpu().numpy(), f)
with open("output_probs_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(test_probs, f)
with open("cost_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(cost_test, f)
with open("test_targets_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(test_targets, f)
with open("test_predictions_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(test_predictions, f)
with open("per_point_losses_test_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(per_point_loss, f)
with open("average_loss_per_model_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(per_model_loss, f)
with open("test_accuracy_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(test_accuracy, f)
with open("dsf_extra_info_test_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(dsf_extra_info_test, f)
with open("train_history_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(history_train, f)
with open("val_history_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(history_test, f)
with open("val_acc_history_dsfmeanpstorefake.pkl", "wb") as f: pickle.dump(history_test_acc, f)
