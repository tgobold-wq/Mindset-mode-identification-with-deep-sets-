...
with open("train_historyN1.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyN1.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputN1.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costN1.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsN1.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsN1.pkl", "wb") as f:
...
with open("per_point_losses_testN1.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelN1.pkl", "wb") as f:
