...
with open("train_historyP3.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyP3.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputP3.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costP3.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsP3.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsP3.pkl", "wb") as f:
...
with open("per_point_losses_testP3.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelP3.pkl", "wb") as f:
