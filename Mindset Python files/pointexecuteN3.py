...
with open("train_historyN3.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyN3.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputN3.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costN3.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsN3.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsN3.pkl", "wb") as f:
...
with open("per_point_losses_testN3.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelN3.pkl", "wb") as f:
