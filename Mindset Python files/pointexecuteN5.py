...
with open("train_historyN5.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyN5.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputN5.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costN5.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsN5.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsN5.pkl", "wb") as f:
...
with open("per_point_losses_testN5.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelN5.pkl", "wb") as f:
