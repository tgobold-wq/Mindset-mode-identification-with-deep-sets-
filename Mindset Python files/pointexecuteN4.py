...
class PointNet(nn.Module):
    def __init__(self, num_classes=3, point_dimension=2, dropout=0.3):
        ...
        self.conv_1 = nn.Conv1d(point_dimension, nfeat, a)
        self.conv_2 = nn.Conv1d(nfeat, nfeat, a)
...
with open("train_historyN4.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyN4.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputN4.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costN4.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsN4.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsN4.pkl", "wb") as f:
...
with open("per_point_losses_testN4.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelN4.pkl", "wb") as f:
