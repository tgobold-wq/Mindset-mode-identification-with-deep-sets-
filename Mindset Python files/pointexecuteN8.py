...
with open("train_historyN8.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyN8.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputN8.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costN8.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsN8.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsN8.pkl", "wb") as f:
...
with open("per_point_losses_testN8.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
with open("average_loss_per_modelN8.pkl", "wb") as f:
