...
with open("train_historyN6.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyN6.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputN6.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costN6.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsN6.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsN6.pkl", "wb") as f:
...
with open("per_point_losses_testN6.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelN6.pkl", "wb") as f:
