...
with open("train_historyP4.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyP4.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputP4.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costP4.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsP4.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsP4.pkl", "wb") as f:
...
with open("per_point_losses_testP4.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelP4.pkl", "wb") as f:
