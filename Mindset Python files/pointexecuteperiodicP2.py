...
with open("train_historyP2.pkl", "wb") as f:
    pickle.dump(history_train, f)
with open("test_historyP2.pkl", "wb") as f:
    pickle.dump(history_test, f)
with open("outputP2.pkl", "wb") as f:
    pickle.dump(out_test, f)
with open("costP2.pkl", "wb") as f:
    pickle.dump(cost_test, f)
with open("test_targetsP2.pkl", "wb") as f:
    pickle.dump(target.cpu().numpy(), f)
with open("test_predictionsP2.pkl", "wb") as f:
...
with open("per_point_losses_testP2.pkl", "wb") as f:
    pickle.dump(per_point_losses_np, f)
    
# Save for future inspection
with open("average_loss_per_modelP2.pkl", "wb") as f:
